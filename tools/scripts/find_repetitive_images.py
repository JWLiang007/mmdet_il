...
if __name__ == "__main__":
    first_cats_json = 'data/coco/annotations/instances_train2017_sel_first_40_cats.json'
    last_cats_json = 'data/coco/annotations/instances_train2017_sel_last_40_cats.json'
